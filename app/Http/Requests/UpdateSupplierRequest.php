    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => [
                ...
                'string',
                'max:50',
                "unique:suppliers,code," . $supplierId
            ],
            ...
            // Bank account fields
            'bank_names' => 'sometimes|required|array|min:1',
            'bank_names.*' => 'required|string|max:255',
            'account_holder_names' => 'sometimes|required|array|min:1',
            'account_holder_names.*' => 'required|string|max:255',
            'branch_names' => 'sometimes|required|array|min:1',
            'branch_names.*' => 'required|string|max:255',
            'account_numbers' => 'sometimes|required|array|min:1',
            'account_numbers.*' => 'required|string|max:255',
            'is_default' => 'nullable|array',
            'is_default.*' => 'nullable|boolean',
            'bank_account_ids' => 'nullable|array',
            'bank_account_ids.*' => 'nullable|exists:supplier_bank_accounts,id',
        ];
    }
